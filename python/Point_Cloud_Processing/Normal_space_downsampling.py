...
def downsample_normal_space_with_bin_control(point_cloud, radius, bin_size=360, num_samples=None):
    """
    ...
    if num_samples is None:
        num_samples=int(len(point_cloud.points)/10)
...
if __name__ == "__main__":
    ...
    # Load a point cloud
    pcd = o3d.io.read_point_cloud(r"C:\Users\mikke\Desktop\0, 15, 45 (test 2 til Mikkel)\0 grader test 2.ply")
    ...
    downsampled_pcd = downsample_normal_space_with_bin_control(pcd, radius=2, bin_size=360)
    end_timer = time.time()
    ...
    o3d.visualization.draw_geometries([downsampled_pcd, AxisArrow], window_name="Downsampled Point Cloud", point_show_normal=False)
