...
class ScannerInterface:
    ...
    def perform_scan(self, stop_event: Optional[threading.Event] = None) -> Optional[o3d.geometry.PointCloud]:
        ...
        try:
            ...
            # TODO: Add a check for contains_non_greyscale_colors(pcd) to determine if colors are greyscale or not. Non-greyscale colors indicate an error: The scan must be redone!
